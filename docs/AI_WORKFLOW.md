...
## 2. Железное правило документации

Проект `Kleptotron` должен оставаться понятным, поэтому мы строго следим за актуальностью папки `docs/` и `GDD.md`.
...
## 3. Резюме для пользователя: Чеклист хорошего промпта
