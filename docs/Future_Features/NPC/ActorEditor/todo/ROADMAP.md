...
- [ ] [14. Ручное разделение меша (Manual Mesh Slicing)](./14.Manual_Mesh_Slicing.md)
    - [x] [14.1. Интерфейс и точная нарезка (Precision UI)](./14.1.Manual_Slicing_UI.md)
    - [x] [14.2. Инфраструктура Manual режима (Base)](./14.2.Manual_Slicing_Base.md)
    - [x] [14.3. Система выделения (Lasso & Selection)](./14.3.Manual_Slicing_Selection.md)
    - [x] [14.4. Переназначение меша (Geometry Reassignment)](./14.4.Manual_Slicing_Action.md)
