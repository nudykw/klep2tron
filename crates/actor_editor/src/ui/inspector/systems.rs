...
pub fn socket_ui_list_sync_system(
    ...
    let mut current_sockets: Vec<(Entity, &crate::ActorSocket)> = socket_query.iter().collect();
...
pub fn socket_ui_list_label_sync_system(
    socket_query: Query<&crate::ActorSocket, Changed<crate::ActorSocket>>,
...
pub fn socket_reset_rotation_system(
    selected: Res<SelectedSocket>,
    mut socket_query: Query<&mut Transform, With<crate::ActorSocket>>,
...
pub fn socket_filter_update_system(
    ...
    socket_query: Query<&crate::ActorSocket>,
...
pub fn socket_filter_ui_system(
    ...
    search_query: Query<&crate::widgets::TextInput, With<SocketSearchInput>>,
...
pub fn selection_counter_sync_system(
    part_query: Query<&crate::SelectedTriangles>,
    mut counter_query: Query<&mut Text, With<crate::TriangleSelectionCounter>>,
) {
    let mut total = 0;
