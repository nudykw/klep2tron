...
use super::types::*;
use crate::systems::optimization::{OptimizationSettings, OptimizedMeshComponent, OptimizeMeshCommand, perform_mesh_optimization};
...
pub fn mesh_optimization_system(
    ...
    mut opt_task: ResMut<crate::systems::optimization::OptimizationTask>,
            ...
            if let Some(source_mesh) = meshes.get(&original.0) {
                *status = EditorStatus::Processing;
                ...
                let task = thread_pool.spawn(async move {
                    ...
                    crate::systems::optimization::OptimizationResult {
                        entity,
