...
pub fn spawn_toast_item(parent: &mut ChildSpawnerCommands, font: &Handle<Font>, icon_font: &Handle<Font>, message: &str, toast_type: ToastType) {
    ...
    parent.spawn((UiNode { node: Node { width: Val::Px(250.0), margin: UiRect::bottom(Val::Px(10.0)), padding: UiRect::all(Val::Px(12.0)), flex_direction: FlexDirection::Row, align_items: AlignItems::Center, ..default() }, background_color: BackgroundColor(Color::srgba(0.1, 0.1, 0.1, 0.95)), border_color: BorderColor::all(color.with_alpha(0.3)), border_radius: BorderRadius::all(Val::Px(8.0)), ..default() }, ToastTimer(Timer::from_seconds(4.0, TimerMode::Once)), )).with_children(|p| {
...
pub fn spawn_progress_bar(parent: &mut ChildSpawnerCommands, font: &Handle<Font>) {
    parent.spawn(UiNode { node: Node { width: Val::Px(300.0), height: Val::Px(40.0), flex_direction: FlexDirection::Column, justify_content: JustifyContent::Center, ..default() }, ..default() }).with_children(|p| {
        p.spawn(UiNode { node: Node { width: Val::Percent(100.0), height: Val::Px(8.0), ..default() }, background_color: BackgroundColor(Color::srgba(1.0, 1.0, 1.0, 0.1)), border_radius: BorderRadius::all(Val::Px(4.0)), ..default() }).with_children(|bg| {
            bg.spawn((UiNode { node: Node { width: Val::Percent(0.0), height: Val::Percent(100.0), ..default() }, background_color: BackgroundColor(Color::srgb(0.3, 0.6, 1.0)), border_radius: BorderRadius::all(Val::Px(4.0)), ..default() }, ProgressBarFill, ));
        });
